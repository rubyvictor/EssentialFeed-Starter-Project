...
//  EssentialFeedTests
//
//  Created by Victor Lee on 17/9/25.
//
...
extension FeedStoreSpecs where Self: XCTestCase {
    func assertThatRetrievalDeliversEmptyOnEmptyCache(on sut: FeedStore, file: StaticString = #filePath, line: UInt = #line) {
        expect(sut, toRetrieve: .success(.empty), file: file, line: line)
    }
    
    func assertThatRetrievalHasNoSideEffectsOnEmptyCache(on sut: FeedStore, file: StaticString = #filePath, line: UInt = #line) {
